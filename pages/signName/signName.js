...
Page({
  ...
  data: {
    color_black_selected: app.globalData.picUrl + '/color_black_selected.png',
    color_black: app.globalData.picUrl + '/color_black.png',
    color_red_selected: app.globalData.picUrl + '/color_red_selected.png',
    color_red: app.globalData.picUrl + '/color_red.png',
  ...
  saveCanvasAsImg() {
    ...
    wx.canvasToTempFilePath({
      ...
      success(res) {
        ...
        var params = {}
        params[_this.data.key + ''] = res.tempFilePath
